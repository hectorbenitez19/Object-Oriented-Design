  ...
  public MarbleSolitaireModelImpl() {
    ...
    for (int i = 0; i < this.board.length; i++) {
      for (int b = 0; b < this.board.length; b++) {
        ...
        if (i < 2 && ((b < 2) || (b >= this.board[b].length - 2))) {
        ...
        else if (i >= this.board[i].length - 2 && (b < 2 || b >= this.board[b].length - 2)) {
          this.board[i][b] = Position.INVALID;
          // System.out.println("("+i+", "+b+")");
        }
  ...
  public MarbleSolitaireModelImpl(int arm) {
    ...
    for (int i = 0; i < this.board.length; i++) {
      for (int b = 0; b < this.board.length; b++) {
        ...
        if (i < armLength && (b < armLength || b >= this.board[b].length - armLength)) {
          this.board[i][b] = Position.INVALID;
        } else if (i >= this.board[i].length - armLength && (b < armLength
            || b >= this.board[b].length - armLength)) {
          this.board[i][b] = Position.INVALID;
        }
