...
public class ViewFactory {
  ...
  /**
   * constructs a view of an animation.
  ...
  public IView createView(String input, IViewModel m, int speed, String output) {
    switch (input) {
      case "text": return new TextView(m, output);
      case "svg": return new SVGView(m, speed, output);
      case "visual": return new VisualView(m, speed);
      default: throw new IllegalArgumentException(input + " not known");
    }
