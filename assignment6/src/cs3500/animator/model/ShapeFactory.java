...
/**
 * A factory class that is used to generate objects of concrete shapes based on the type wanted.
 */
public class ShapeFactory {
  ...
  public Shape createShape(String shapeType, String name, Position2D p, Size s, ShapeColor c) {
    ...
    switch (shapeType) {
      case "square": return new Square(name, p, s, c);
      case "rectangle": return new Rectangle(name, p, s, c);
      case "ellipse": return new Ellipse(name, p, s, c);
