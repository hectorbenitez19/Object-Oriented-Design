 ...
 * information to each of the views. Contains only getter methods to ensure that the model cannot be
 * mutated.
 */
public interface IViewModel {
   ...
   * size that are determined through linear interpolation calculations. This method will only
   * return the Shapes in the animation that have one or more motions.
   *
