...
public class Motion {
  ...
  public boolean equals(Object a) {
    ...
    return (this.endTick == that.endTick &&
        this.startTick == that.startTick &&
        this.startShape.equals(that.startShape) &&
        this.endShape.equals(that.endShape));
  }

  @Override
  public int hashCode() {
    return Objects.hash(this.startTick, this.startShape, this.endTick, this.endShape);
  }
